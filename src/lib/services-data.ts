...
export const SERVICE_DETAILS: ServiceDetail[] = [
  ...
  },
  {
    ...
    icon: Workflow,
    category: "Growth",
    metaTitle: "Business Automation Services in Oman & UAE | OMSA",
    metaDescription:
      "Business automation services for companies in Oman, the UAE and the GCC — connecting workflows, reducing repetitive manual work and improving operational efficiency.",
    problem:
      "Repetitive data entry, manual handoffs between systems, missed follow-ups and administrative bottlenecks quietly consume hours that could go toward customers — spread across many small, repeated tasks rather than one obvious expense.",
    solution:
      "A structured approach to business automation that starts with how your processes actually work today — mapping workflows, deciding what should be automated and what should stay human-controlled, then building and testing the automation around that.",
    h1: "Business Automation That Turns Repetitive Work Into Smarter Workflows",
    heroBody: [
      "Automation is only useful when it's solving a real operational problem — not because a task can technically be automated.",
      "OMSA designs automation around your actual business processes: how leads move through your pipeline, how enquiries get handled, how information passes between the tools your team already uses, and where manual steps are slowing things down.",
      "The outcomes we design for are practical: fewer repetitive manual steps, faster information movement, more consistent workflows, better-handled leads and less administrative friction for your team.",
    ],
    heroCta: {
      primaryLabel: "Talk to Us About Automation",
    },
    sections: [
      {
        id: "cost-of-manual-work",
        eyebrow: "Why it matters",
        h2: "The Cost of Manual Work Is More Than Time",
        paragraphs: [
          { text: "Manual, repetitive work rarely shows up as a single line item — it's spread across small tasks that add up across a team, a week, a quarter." },
          { text: "The patterns tend to look familiar:" },
        ],
        bullets: [
          "Repetitive data entry across multiple systems",
          "Copying information between tools by hand",
          "Missed or delayed follow-ups",
          "Inconsistent handoffs between team members",
          "Manual notifications that depend on someone remembering",
          "Lead information scattered across inboxes, spreadsheets and forms",
          "Repetitive reporting pulled together manually each cycle",
          "Approval bottlenecks that stall otherwise-ready work",
          "Information trapped in tools that don't talk to each other",
          "Teams repeating predictable administrative tasks every day",
        ],
        afterBullets: [
          { text: "None of this is usually anyone's fault — it's what happens when processes grow organically without anyone stepping back to redesign how information should actually move." },
        ],
      },
      {
        id: "what-automation-means",
        eyebrow: "What it actually means",
        h2: "What Business Automation Actually Means",
        paragraphs: [
          { text: "Automation is often oversimplified to \"making things run without people.\" In practice, it's a defined system:" },
        ],
        bullets: [
          "Trigger — something happens that should start a process",
          "Logic and rules — the conditions that decide what happens next",
          "Data movement — information passes between systems accurately",
          "Action — the actual task gets carried out",
          "Human review, where required — a person checks or approves before the process continues",
          "Measurement — the workflow's performance is visible, not assumed",
        ],
        afterBullets: [
          { text: "Good automation isn't about removing people from every process. It's about deciding deliberately what should be automated, what should remain human-controlled, where information should move, and what should happen when something doesn't fit the expected pattern." },
        ],
      },
      {
        id: "automation-services",
        eyebrow: "Our automation services",
        h2: "Our Business Automation Services",
        subsections: [
          { h3: "Workflow Automation", body: "We connect repetitive steps — task creation, notifications, status updates, routing and follow-up triggers — into a defined workflow, rather than leaving them dependent on someone remembering to act." },
          { h3: "Lead Management Automation", body: "A typical flow moves a captured lead through structuring, a qualification step, routing to the right person, and a follow-up trigger. Where a chatbot is the entry point for that lead, this connects directly with our AI Chatbots work.", link: { anchor: "AI Chatbots", link: { kind: "service", slug: "ai-chatbots" } } },
          { h3: "Customer Enquiry Automation", body: "Enquiries can be captured, categorized, routed and acknowledged automatically, with escalation to a person built in — not every interaction should be handled without a human involved, and we design for that distinction deliberately." },
          { h3: "Data & System Integration", body: "We connect information between systems through supported APIs and integrations where technically appropriate. The right integrations depend entirely on the tools you actually use, which we confirm during scoping rather than assuming in advance." },
          { h3: "Reporting & Data Workflows", body: "Recurring data collection, structured reporting and notifications can be automated so information moves without manual assembly each cycle — often connected to the same measurement setup used across the rest of the business.", link: { anchor: "measurement setup", link: { kind: "service", slug: "google-analytics" } } },
          { h3: "Marketing Workflow Automation", body: "We design responsible automation around lead handoff, campaign-related workflows, customer journey triggers and internal notifications — not mass unsolicited messaging." },
          { h3: "Internal Operations Automation", body: "Approvals, recurring administrative processes, information routing, task coordination and internal requests are common candidates for automation once they follow a predictable pattern." },
          { h3: "AI-Assisted Automation", body: "AI can assist with classification, summarization, information extraction, conversational interfaces and routing support. Depending on the use case, AI output may need human validation before it's acted on." },
        ],
      },
      {
        id: "disconnected-to-connected",
        eyebrow: "Connected systems",
        h2: "From Disconnected Tools to Connected Workflows",
        paragraphs: [
          { text: "Most businesses accumulate tools over time — a CRM here, a spreadsheet there, a booking system, a helpdesk — and those tools rarely exchange information on their own." },
          { text: "The result is familiar: duplicate entry, inconsistent records, delayed handoffs, manual copying and unclear ownership of information as it moves between systems." },
          { text: "Carefully designed integrations can reduce these issues by letting information move automatically between the tools you already use — though we won't promise universal compatibility with every platform. Compatibility depends on what each system's API actually supports." },
        ],
      },
      {
        ...
        h2: "AI + Automation",
        paragraphs: [
          { text: "Traditional automation works well when rules are predictable — if this happens, do that. It's reliable, but it struggles with anything that requires interpretation." },
          { text: "AI can help where tasks involve language, classification, summarization, information extraction or conversational input — the kind of work that doesn't reduce neatly to a fixed rule." },
          { text: "The strongest solutions usually combine both: deterministic workflow logic for the predictable parts, and AI where judgment or language understanding is genuinely needed — including as a conversational entry point through an AI chatbot.", link: { anchor: "AI chatbot", link: { kind: "service", slug: "ai-chatbots" } } },
        ],
      },
      {
        ...
        paragraphs: [
          { text: "Some workflows should never run entirely without a person. We design for that deliberately, not as an afterthought." },
        ],
        bullets: [
          ...
          "Exceptions that don't match the expected pattern",
          "Low-confidence AI outputs",
        ],
        afterBullets: [
          { text: "Human oversight in these cases isn't a limitation of the automation — it's intentional workflow design." },
        ],
      },
      {
        id: "oman-uae-gcc-automation",
        eyebrow: "Oman, UAE & GCC",
        h2: "Automation for Oman, UAE and GCC Businesses",
        paragraphs: [
          { text: "Businesses across Oman, the UAE and the wider GCC are often scaling operations, managing growing enquiry volumes, coordinating across teams, and juggling a mix of digital tools that weren't necessarily chosen to work together." },
          { text: "Many also handle customers in more than one language and, increasingly, across more than one market — which adds real complexity to how leads and enquiries should be routed and handled." },
          { text: "We don't have regional automation adoption figures to quote, and we won't invent them. What we can offer is automation built around how your business actually operates." },
        ],
      },
      {
        id: "english-arabic-workflows",
        eyebrow: "English & Arabic",
        h2: "English and Arabic Workflows",
        paragraphs: [
          { text: "Where a workflow involves customer communication — templates, notifications, chatbot interactions — English and Arabic content usually need to be planned separately rather than as a direct translation of one another." },
          { text: "That affects routing logic, message templates, and how any AI-assisted step is tested. We don't claim flawless Arabic automation — language handling needs the same testing and review as any other part of the workflow, particularly where AI is involved." },
        ],
      },
      {
        id: "automation-security",
        eyebrow: "Security & responsibility",
        h2: "Automation Security and Data Responsibility",
        paragraphs: [
          { text: "Automation touches business data by design, which makes deliberate access control part of the build, not an afterthought." },
        ],
        bullets: [
          "Minimum necessary data access for each workflow step",
          "Clear permissions on what a workflow can read, write or trigger",
          "Careful handling of credentials and secrets",
          "Appropriate system access, scoped to what's actually needed",
          "Defined error handling for failed or unexpected steps",
          "Logging that supports troubleshooting without over-collecting data",
          "Testing before a workflow runs against real business data",
          "Human review for the steps that warrant it",
        ],
        afterBullets: [
          { text: "We can't claim absolute security or guaranteed compliance with every regulatory framework — no automation provider responsibly can. What we commit to is designing with these considerations addressed deliberately, including any limitations specific to the platforms and vendors involved." },
        ],
      },
    ],
    benefitsEyebrow: "What you receive",
    benefitsHeading: "What You Receive",
    benefitsIntro: "The exact scope depends on your processes and systems, but a professional OMSA automation engagement can include:",
    benefits: [
      "A workflow and process analysis",
      "An automation opportunity map",
      "Workflow architecture",
      "Integration planning",
      "Automation implementation",
      "AI-assisted workflow components, where scoped",
    ...
    process: [
      { step: "Process Discovery", detail: "We walk through how your operations actually run today, with the people doing the work, rather than assuming how a process should look." },
      { step: "Workflow Mapping", detail: "Current workflows are mapped in detail — where information starts, how it moves, and where the delays and manual steps actually occur." },
      { step: "Automation Opportunity Analysis", detail: "We identify which parts of the workflow are genuinely worth automating, and which should stay human-controlled." },
      { step: "Architecture & Integration Planning", detail: "We plan how systems will connect, what data moves where, and what the workflow needs to handle exceptions correctly." },
      { step: "Build & Configuration", detail: "The automation is built and configured against your actual systems and data." },
      { step: "Testing & Exception Handling", detail: "We test the workflow against real scenarios, including edge cases, before it touches live business data." },
      { step: "Deployment", detail: "The automation is rolled out, typically in phases, with monitoring in place from day one." },
      { step: "Measurement & Improvement", detail: "We review how the workflow is performing against the problem it was built to solve, and refine it as real usage reveals gaps." },
    ],
    postBenefitsSection: {
      id: "vs-ai-chatbots",
      eyebrow: "Choosing the right service",
      h2: "Business Automation vs. AI Chatbots",
      paragraphs: [
        { text: "Business Automation focuses on processes, systems, triggers, actions and how data moves between them — the operational backbone behind a workflow." },
        { text: "AI Chatbots focus on conversational interaction, and can become the interface that feeds information into an automated workflow.", link: { anchor: "AI Chatbots", link: { kind: "service", slug: "ai-chatbots" } } },
        { text: "The two services can work independently or together. A chatbot without automation behind it still has to be handled manually once a conversation ends; automation without a conversational front end still needs another way to capture the information that starts the process." },
      ],
    },
    whoForIntro: "OMSA Business Automation is suited to:",
    whoFor: [
      { title: "SMEs and Growing Businesses", body: "Teams outgrowing manual processes but not yet ready for a large operational overhaul." },
      { title: "Professional Service Companies", body: "Businesses where consistent client handling and follow-up directly affect service quality." },
      { title: "Sales Teams", body: "Teams that need leads routed, qualified and followed up on consistently, without manual tracking." },
      { title: "Customer Support Operations", body: "Teams handling a high volume of repetitive enquiries alongside more complex cases." },
      { title: "Businesses With Repetitive Administrative Workflows", body: "Companies where the same manual steps repeat across departments or reporting cycles." },
      { title: "Teams Using Multiple Disconnected Systems", body: "Businesses where information regularly needs to move between tools that don't talk to each other." },
      { title: "Businesses Scaling Across Oman, the UAE and the GCC", body: "Companies whose operations are growing faster than their current manual processes can support." },
    ],
    preFaqSection: {
      id: "why-omsa",
      eyebrow: "Why OMSA",
      h2: "Why OMSA for Business Automation",
      paragraphs: [
        { text: "OMSA works at the intersection of AI, websites, business processes and analytics — which matters, because the most useful automation is usually connected to the rest of your digital presence, not built as an isolated tool." },
        { text: "We start from the operational problem, not from the automation itself. If a simpler fix genuinely solves it, that's what we'll recommend rather than building automation for its own sake." },
        { text: "We design around your actual systems and workflows, not a generic template applied regardless of how your business operates." },
        { text: "And we're direct about what automation can and can't do — no promises of guaranteed savings, no claim that every process should be automated, and no unsupported claims about results." },
      ],
    },
    faqs: [
      { q: "What is business automation?", a: "Business automation is the practice of connecting triggers, rules, data movement and actions into defined workflows — reducing repetitive manual work while keeping human review in place wherever it's genuinely needed." },
      { q: "What business processes can be automated?", a: "Common candidates include lead routing and follow-up, enquiry handling, recurring reporting, internal approvals, notifications and data movement between systems. The right candidates depend on how predictable and repetitive the process actually is." },
      { q: "Can automation connect our existing systems?", a: "Often, yes, where each system offers a supported API or integration. We confirm what's actually possible with your specific tools during scoping rather than assuming compatibility in advance." },
      { q: "What is the difference between business automation and AI?", a: "Business automation is the workflow — triggers, rules, data movement and actions. AI is a capability that can assist within that workflow, particularly for tasks involving language, classification or interpretation. The strongest solutions often combine both." },
      { q: "Can AI chatbots connect to automated workflows?", a: "Yes. AI chatbots can act as the entry point that triggers a workflow — capturing information, qualifying an enquiry and handing it off to an automated process.", link: { anchor: "AI chatbots", link: { kind: "service", slug: "ai-chatbots" } } },
      { q: "Will automation replace employees?", a: "Automation is designed to remove repetitive, predictable work from a team's workload, not to replace the judgment people bring to complex, sensitive or high-value situations. We design human review into workflows deliberately, not as an exception." },
      { q: "Is business automation suitable for small businesses?", a: "Yes. Automation is often most valuable for smaller teams, where the same few people are handling repetitive tasks that take time away from customers. Scope is matched to what actually makes sense for your size and processes." },
      { q: "How long does an automation project take?", a: "Timelines depend on workflow complexity, the number of systems involved, data access, and the amount of testing required. We can give you a realistic estimate once we understand what you're trying to automate." },
    ],
    finalCta: {
      heading: "Find Out What's Actually Worth Automating",
      body: "Identify the repetitive work, the slow handoffs, the disconnected systems and the repeated customer or admin processes that are quietly costing your team time. Let's work through what's genuinely worth automating.",
      primaryLabel: "Talk to Us About Automation",
      secondaryLabel: "Explore AI Chatbots",
      secondaryLink: { kind: "service", slug: "ai-chatbots" },
    },
  ...
  },
  {
    ...
    icon: BarChart3,
    category: "Insights",
    metaTitle: "Google Analytics & GA4 Services in Oman & UAE | OMSA",
    metaDescription:
      "Google Analytics 4 setup, event tracking and conversion measurement for businesses in Oman, the UAE and the GCC — built around real business decisions.",
    problem:
      "GA4 is often installed but never configured around what the business actually needs to know — important actions go untracked, events are duplicated or inconsistent, and reports get reviewed without anyone quite trusting the numbers.",
    solution:
      "A measurement approach that starts with the business questions worth answering, then builds GA4 configuration, event tracking and reporting around those questions — rather than installing a default setup and hoping it's useful.",
    h1: "Google Analytics & GA4 Setup Built Around Business Decisions",
    heroBody: [
      "Collecting data isn't the same as understanding your business. A GA4 property with default settings can technically \"work\" while still leaving the questions that actually matter unanswered.",
      "OMSA builds measurement around what a business needs to know: where visitors come from, what they do once they arrive, which actions actually matter, where conversion paths break down, and which marketing activity is contributing to real outcomes.",
      "The goal is a setup you can trust enough to make decisions from — not a dashboard full of metrics nobody uses.",
    ],
    heroCta: {
      primaryLabel: "Talk to Us About Your Analytics",
    },
    sections: [
      {
        id: "more-data-problem",
        eyebrow: "Why it matters",
        h2: "More Data Does Not Automatically Mean Better Decisions",
        paragraphs: [
          { text: "A GA4 property can be technically live and still fail to answer the questions a business actually has." },
          { text: "The problems tend to repeat:" },
        ],
        bullets: [
          "GA4 installed but never configured around business goals",
          "Important actions never tracked as events",
          "Duplicate events inflating or distorting the numbers",
          "Unclear or inconsistent conversion definitions",
          "Inconsistent campaign tagging across channels",
          "Internal or test traffic quietly skewing the data",
          "Reports delivered without context or explanation",
          "Stakeholders focused on vanity metrics rather than outcomes",
          "No clear connection between website behaviour and business results",
        ],
        afterBullets: [
          { text: "None of this means analytics data is ever perfectly complete — no measurement system is. It means the gap between \"data exists\" and \"data is trustworthy enough to act on\" is usually a configuration problem, not a platform limitation." },
        ],
      },
      {
        id: "start-with-questions",
        eyebrow: "Where measurement should start",
        h2: "Measurement Starts With Business Questions",
        paragraphs: [
          { text: "Implementation should begin with the questions the business actually needs answered, not with a checklist of GA4 features to turn on." },
        ],
        bullets: [
          "Which channels bring genuinely relevant visitors?",
          "Which landing pages generate meaningful engagement?",
          "Which actions indicate real commercial intent?",
          "Where do users abandon important journeys?",
          "Which campaigns are contributing to leads?",
          "Which website improvements should be prioritized next?",
        ],
        afterBullets: [
          { text: "Only once those questions are defined does it make sense to design the events, key events and reporting that answer them." },
        ],
      },
      {
        id: "ga-services",
        eyebrow: "Our Google Analytics services",
        h2: "Our Google Analytics Services",
        subsections: [
          { h3: "GA4 Setup & Configuration", body: "Property and data stream configuration, appropriate settings and measurement planning, with implementation validated against how your site actually behaves. We configure within Google's platform — we don't control how Google's algorithms process or report that data." },
          { h3: "Event Tracking", body: "We track the interactions that actually indicate something meaningful — form submissions, CTA clicks, downloads, key navigation actions and ecommerce events where applicable — as examples of the kind of activity worth measuring, scoped to your site." },
          { h3: "Key Events & Conversion Measurement", body: "We identify which actions genuinely matter to the business and mark them as key events, so conversion analysis reflects real commercial intent rather than treating every interaction as equally significant." },
          { h3: "Google Tag Manager", body: "Where appropriate, GTM helps manage measurement tags and events without requiring a code change for every update. It isn't required for every implementation — we scope it based on what your setup actually needs." },
          { h3: "Acquisition & Campaign Measurement", body: "We work through source, medium, channel groupings, campaign tagging and UTM parameters, with consistent naming so acquisition reporting stays reliable as campaigns multiply." },
          { h3: "Google Search Console Integration", body: "Search Console shows search-performance information — queries, impressions and clicks. GA4 shows on-site behaviour once a visitor arrives. Connecting the two supports a more complete view of organic performance as part of the broader SEO picture.", link: { anchor: "broader SEO picture", link: { kind: "service", slug: "seo" } } },
          { h3: "Reporting & Dashboards", body: "Reporting should prioritize the decisions it needs to support, not display every metric GA4 makes available. We don't claim to support every dashboard platform — reporting tools are scoped to what you actually use." },
          { h3: "Analytics Audits", body: "A review of your existing implementation — event quality, duplicate tracking, key event configuration, campaign tracking, data consistency and measurement gaps — before recommending changes." },
        ],
      },
      {
        id: "events-key-events-conversions",
        eyebrow: "Getting the terminology right",
        h2: "GA4 Events, Key Events and Conversions",
        paragraphs: [
          { text: "An event is a recorded user interaction — a page view, a click, a form submission, a scroll past a certain point." },
          { text: "A key event is an event you've marked as particularly important to the business inside GA4 — the actions that actually indicate progress toward a goal, not every interaction that happens to be tracked." },
          { text: "In marketing and advertising contexts, important actions can also be used for conversion measurement and analysis — but that's a downstream use of well-defined key events, not a separate tracking system. Getting the terminology and configuration right here matters, because it's the foundation everything else in the reporting is built on." },
        ],
      },
      {
        id: "analytics-lead-generation",
        eyebrow: "Lead generation",
        h2: "Analytics for Lead Generation",
        paragraphs: [
          { text: "For service businesses, a typical journey looks like: a traffic source brings a visitor to a landing page, they explore your services, engage with a call to action, and complete a form or contact action." },
          { text: "GA4 can measure that digital journey clearly. What it generally can't tell you on its own is whether the resulting lead was actually qualified, or what happened to it afterward — that usually requires connecting analytics data with your CRM or business records." },
          { text: "This distinction matters for professional accuracy: GA4 measures digital interactions, not lead quality or revenue outcomes, unless that data is deliberately connected back into the system." },
        ],
      },
      {
        id: "attribution",
        eyebrow: "Attribution",
        h2: "Attribution and Marketing Performance",
        paragraphs: [
          { text: "Customers rarely convert from a single touchpoint. Attribution models attempt to distribute credit across the channels and interactions that led to a conversion — but every model involves assumptions, not certainty." },
          { text: "Cross-device behaviour, consent choices and data availability all limit how completely any single journey can be reconstructed. Different attribution models can show meaningfully different pictures of the same underlying activity." },
          { text: "We won't claim GA4 can identify the exact cause of every sale, and any attribution report should be read as a reasonable model of performance, not as objective proof of what caused a conversion." },
        ],
      },
      {
        id: "data-quality",
        ...
        h2: "Data Quality",
        paragraphs: [
          { text: "Every analytics decision is only as reliable as the implementation behind it." },
        ],
        bullets: [
          "Duplicate events inflating activity counts",
          "Missing events leaving gaps in the picture",
          "Inconsistent naming across events and parameters",
          "Incorrect or missing parameters on key events",
          "Self-referrals distorting acquisition data",
          "Internal or test traffic mixed into real user data",
          "Inconsistent campaign tagging over time",
          "Implementation changes that break historical comparability",
        ],
        afterBullets: [
          { text: "We treat data quality as an ongoing concern rather than a one-time setup task — implementations drift as sites change, and validation needs to happen periodically, not just at launch." },
        ],
      },
      {
        id: "privacy-aware-measurement",
        eyebrow: "Privacy",
        h2: "Privacy-Aware Measurement",
        paragraphs: [
          { text: "Measurement should collect what's genuinely needed and avoid unnecessary personal information by design." },
        ],
        bullets: [
          "Data minimization in what's tracked and stored",
          "Consent requirements that vary by jurisdiction and setup",
          "Appropriate tag behaviour based on consent state",
          "Avoiding collection of unnecessary personal information",
          "Correct platform-level privacy settings",
          "First-party measurement principles where applicable",
        ],
        afterBullets: [
          { text: "This section is informational, not legal advice. We don't claim compliance with every privacy law, and we don't claim that any single feature — including Google's Consent Mode — resolves every compliance obligation on its own. Legal requirements should be confirmed with qualified counsel for your specific business and markets." },
        ],
      },
      {
        id: "ga-seo",
        eyebrow: "Analytics + SEO",
        h2: "Google Analytics + SEO",
        paragraphs: [
          { text: "GA4 and Search Console answer different questions, and both matter for a complete picture of organic performance." },
          { text: "GA4 can show organic landing-page engagement, meaningful on-site actions, user journeys and conversion-related behaviour once a visitor arrives.", link: { anchor: "organic landing-page engagement", link: { kind: "service", slug: "seo" } } },
          { text: "Search Console shows the queries, impressions and clicks that happen before that — the search-visibility side of the picture." },
          { text: "Where the underlying technical health of the site is in question — crawlability, indexing, performance — that's the territory Technical SEO covers.", link: { anchor: "Technical SEO", link: { kind: "service", slug: "technical-seo" } } },
        ],
      },
      {
        id: "ga-website-design",
        eyebrow: "Analytics + website design",
        h2: "Google Analytics + Website Design",
        paragraphs: [
          { text: "Once real usage data exists, it can inform navigation decisions, CTA performance, landing-page behaviour, content engagement and where conversion journeys break down." },
          { text: "Analytics shows what happened — it doesn't automatically prove why a user behaved a certain way, which is why data should inform design decisions rather than dictate them outright." },
          { text: "Where analysis suggests real structural issues, that connects back to our website work.", link: { anchor: "website work", link: { kind: "service", slug: "website-design" } } },
        ],
      },
      {
        id: "oman-uae-gcc-analytics",
        eyebrow: "Oman, UAE & GCC",
        h2: "Analytics for Oman, UAE and GCC Businesses",
        paragraphs: [
          { text: "Businesses running campaigns across Oman, the UAE and the wider GCC often need to compare performance across locations, manage multilingual websites and measure lead generation consistently across markets." },
          { text: "That requires deliberate campaign structure and consistent tagging from the start — inconsistent naming across markets makes cross-market comparison unreliable, regardless of how much data is being collected." },
          { text: "We don't fabricate benchmark figures for any market, and geographic reporting in GA4 is not perfectly accurate at the individual-user level — it's a useful signal, not a precise map of every visitor's location." },
        ],
      },
    ],
    benefitsEyebrow: "What you receive",
    benefitsHeading: "What You Receive",
    benefitsIntro: "The exact scope depends on your website and goals, but a professional OMSA Google Analytics engagement can include:",
    benefits: [
      "A measurement plan",
      "GA4 setup and configuration",
      "An event tracking plan",
      "Key event configuration",
      "Google Tag Manager implementation, where scoped",
      "Campaign and UTM guidance",
    ...
    process: [
      { step: "Business & Measurement Discovery", detail: "We start with the business questions that actually need answering, before deciding what to track." },
      { step: "Existing Analytics Audit", detail: "Where GA4 or another tool is already in place, we review what's currently tracked, and what's missing, duplicated or inconsistent." },
      { step: "Measurement Plan", detail: "We define the events, key events and reporting structure that will actually answer your business questions." },
      { step: "GA4 / Tag Configuration", detail: "GA4 properties, data streams and tags are configured to match the measurement plan." },
      { step: "Event & Key Event Setup", detail: "Meaningful interactions are implemented as events, with the genuinely important ones marked as key events." },
      { step: "Validation & QA", detail: "We validate that events fire correctly and consistently before relying on the data for decisions." },
      { step: "Reporting Framework", detail: "Reports are built around the decisions they need to support, not around every metric available." },
      { step: "Ongoing Review & Improvement", detail: "Implementations drift as sites and campaigns change — we review periodically to catch gaps before they affect decisions." },
    ],
    postBenefitsSection: {
      id: "setup-vs-strategy",
      eyebrow: "Setup vs. strategy",
      h2: "GA4 Setup vs. Analytics Strategy",
      paragraphs: [
        { text: "Basic setup answers one question: is data being collected?" },
        { text: "Analytics strategy asks a different one: are we collecting the right data to actually answer the business questions that matter?" },
        { text: "Configuration should follow measurement objectives, not the other way around — deciding what to track only after defining what you need to know keeps the setup useful instead of just technically functional." },
      ],
    },
    whoForIntro: "OMSA Google Analytics services are suited to:",
    whoFor: [
      { title: "Businesses Without Reliable Measurement", body: "Companies making decisions on instinct because the current data isn't trusted." },
      { title: "Websites Generating Leads", body: "Businesses that need to understand which channels and pages actually contribute to enquiries." },
      { title: "Marketing Teams", body: "Teams that need consistent, defensible reporting on channel and campaign performance." },
      { title: "SMEs and Startups", body: "Businesses that need measurement scoped realistically to their size, not an enterprise setup they'll never use." },
      { title: "Businesses Running Paid Campaigns", body: "Companies that need accurate acquisition and conversion data to evaluate ad spend." },
      { title: "Companies Investing in SEO", body: "Businesses that need to understand what happens after an organic visitor actually lands on the site." },
      { title: "Businesses Preparing a Website Redesign", body: "Companies that want a measurement baseline in place before and after a redesign, to judge its actual impact." },
      { title: "Organizations Operating Across Multiple Markets", body: "Businesses that need consistent measurement structure to compare performance across locations." },
    ],
    preFaqSection: {
      id: "why-omsa",
      eyebrow: "Why OMSA",
      h2: "Why OMSA for Google Analytics",
      paragraphs: [
        { text: "OMSA works at the intersection of analytics, SEO, websites, conversion and digital marketing — which matters, because analytics is most useful when it's connected to the rest of your digital strategy, not treated as a standalone dashboard project." },
        { text: "We build measurement around the decisions your business actually needs to make, not around installing every feature GA4 offers." },
        { text: "We're not claiming a Google partnership or certification we haven't verified, and we won't pretend otherwise — what we bring is practical, hands-on implementation experience." },
        { text: "And we're direct about what analytics can and can't tell you — no claims of perfect attribution, no promises that every metric proves causation, and no dashboards built to look impressive rather than be useful." },
      ],
    },
    faqs: [
      { q: "What is GA4?", a: "GA4 (Google Analytics 4) is Google's current analytics platform, built around events rather than the older session-based model. It's the standard for measuring website and app behaviour today." },
      { q: "Can you set up Google Analytics for an existing website?", a: "Yes. Most engagements start with an existing site — we audit what's currently tracked, identify gaps or issues, and build the configuration around your actual business questions." },
      { q: "What should I track in GA4?", a: "That depends on your business, but it generally includes the actions that indicate real commercial intent — form submissions, key CTA interactions, meaningful page engagement and, where relevant, ecommerce events — rather than every possible interaction on the site." },
      { q: "What is the difference between events and key events?", a: "An event is any recorded user interaction. A key event is an event you've marked as particularly important to the business — the subset that actually indicates progress toward a goal, used for conversion analysis." },
      { q: "Can GA4 track leads?", a: "GA4 can track the digital actions associated with a lead — a form submission or contact click, for example. Whether that lead was actually qualified, or what happened to it afterward, generally requires connecting that data with your CRM or business records." },
      { q: "Do I need Google Tag Manager?", a: "Not always. GTM is useful when you need to manage multiple tags and events without a code change every time, but simpler implementations may not require it. We scope this based on your actual setup." },
      { q: "How are Google Analytics and Search Console different?", a: "Search Console shows search-performance data — queries, impressions and clicks — before a visitor reaches your site. GA4 shows what happens on your site once they arrive. The two are complementary, not interchangeable.", link: { anchor: "complementary", link: { kind: "service", slug: "seo" } } },
      { q: "Can you audit an existing GA4 setup?", a: "Yes. We review implementation quality, event configuration, key events, campaign tracking, data consistency and measurement gaps, then recommend prioritized fixes." },
    ],
    finalCta: {
      heading: "Move From \"Analytics Installed\" to \"We Understand the Data\"",
      body: "Having Google Analytics running isn't the same as understanding what it's telling you. Let's review your current setup and identify what it should actually be showing you.",
      primaryLabel: "Talk to Us About Your Analytics",
      secondaryLabel: "Explore SEO Services",
      secondaryLink: { kind: "service", slug: "seo" },
    },
  ...
  },
  {
    ...
    short: "Coordinated digital channels, campaigns and measurement that turn attention into qualified demand.",
    icon: Megaphone,
    category: "Growth",
    metaTitle: "Digital Marketing Services in Oman & UAE | OMSA",
    metaDescription:
      "Digital marketing services in Oman and the UAE — coordinated strategy, paid campaigns, content and measurement built by OMSA Digital & AI Studio.",
    problem:
      "Most digital marketing under-performs not because a single channel fails, but because the channels were never connected. Ads run without a landing page built to convert them. Social content follows a content calendar instead of a business goal. Traffic arrives with no clear view of what it actually leads to.",
    solution:
      "A digital marketing strategy that connects business goals, audience understanding, channel selection, messaging, landing-page experience and measurement into one coordinated system — so paid, organic, content and conversion work reinforce each other instead of competing for the same attention.",
    h1: "Digital Marketing Built Around Growth, Leads and Measurable Decisions",
    heroBody: [
      "Most businesses don't have a digital marketing problem. They have a coordination problem — search, paid campaigns, social content, landing pages and analytics running as separate efforts instead of one connected system.",
      "OMSA builds digital marketing around a simple idea: every channel should point toward the same business goal, land on an experience built to convert it, and feed back into measurement that shows what's actually working.",
      "For businesses in Oman, Muscat, the UAE and the wider GCC, that means campaigns and content built around how your specific customers actually search, compare and decide — not a generic playbook applied everywhere at once.",
    ],
    heroCta: {
      primaryLabel: "Start Your Digital Marketing Strategy",
    },
    sections: [
      {
        id: "disconnected-marketing",
        eyebrow: "Where digital marketing breaks down",
        h2: "The Problem With Disconnected Digital Marketing",
        paragraphs: [
          { text: "Most digital marketing doesn't fail because a channel is weak. It fails because the channels were never connected to each other or to a shared measurement of success." },
          { text: "In practice, that shows up in familiar ways:" },
        ],
        bullets: [
          "Ads running without a landing page built to convert them",
          "Social content disconnected from actual business goals",
          "Traffic arriving with no clear measurement of what it leads to",
          "Inconsistent messaging across ads, landing pages and social content",
          "Separate agencies or tools working without a shared strategy",
          "Campaigns optimized around impressions and clicks rather than business outcomes",
          "Leads generated but poorly handed off to sales or follow-up",
          "No clear understanding of which channel or campaign is actually driving results",
        ],
        afterBullets: [
          { text: "None of these are unusual. They're what happens when digital marketing is treated as a set of separate tactics instead of one connected system." },
        ],
      },
      {
        id: "strategy-before-channels",
        eyebrow: "Our approach",
        h2: "Strategy Comes Before Channel Execution",
        paragraphs: [
          { text: "Choosing channels before defining the strategy is one of the most common — and most expensive — mistakes in digital marketing." },
          { text: "OMSA builds the strategy layer first, covering:" },
        ],
        bullets: [
          "Business goals and what success actually needs to look like",
          "Audience understanding and the customer journey",
          "Channel selection, based on where your audience actually is",
          "Search demand and how people currently look for what you offer",
          "Content and messaging that stays consistent across channels",
          "Landing-page experience for the traffic being generated",
          "Measurement, so performance can be judged against real outcomes",
          "Iteration, since channels and competition change over time",
        ],
        afterBullets: [
          { text: "Only once that foundation is in place does channel selection and execution begin." },
        ],
      },
      {
        id: "our-services",
        ...
        subsections: [
          { h3: "Digital Marketing Strategy", body: "Channel prioritization, customer-journey mapping, campaign planning and a measurement framework built around your actual business goals — the foundation every other service below builds on." },
          { h3: "Google Ads & Paid Search", body: "Paid search campaigns built to capture high-intent demand — the searches from people actively looking for what you offer. We don't guarantee a specific cost per click, cost per acquisition or ranking position; no responsible provider can." },
          { h3: "Social Media Marketing", body: "Content, distribution, community management and paid social planned around your business goals rather than a content calendar for its own sake. We don't promise follower growth — the objective is relevant reach and engagement that supports the business." },
          { h3: "Campaign Landing Pages", body: "Conversion-focused pages built for a specific campaign or offer, so paid and organic traffic arrives somewhere designed to convert it rather than a generic homepage.", link: { anchor: "designed to convert it", link: { kind: "service", slug: "website-design" } } },
          { h3: "Content & Messaging", body: "Coordinated messaging across ads, landing pages and social content, so a prospective customer encounters a consistent story regardless of where they first find you." },
          { h3: "Conversion Optimization", body: "Reducing the friction between a visitor arriving and taking a meaningful action — clearer calls to action, stronger message match and a more direct path to enquiry. We don't claim a guaranteed conversion-rate increase; the work is evidence-led, not promise-led." },
          { h3: "Remarketing & Audience Re-engagement", body: "Reaching people who have already shown interest, where the relevant platforms and audience size make it worthwhile. Availability and setup vary by platform, market and privacy requirements, and we scope this honestly rather than assuming it applies universally." },
          { h3: "Analytics & Measurement", body: "Campaign and channel performance tracked through GA4, so decisions are based on what's actually happening rather than platform-reported clicks and impressions alone.", link: { anchor: "GA4", link: { kind: "service", slug: "google-analytics" } } },
        ],
      },
      {
        id: "marketing-and-seo",
        eyebrow: "Digital marketing & SEO",
        h2: "Digital Marketing and SEO Work Best Together",
        paragraphs: [
          { text: "SEO builds organic discovery over time — the visibility that keeps showing up in search without ongoing spend once it's established.", link: { anchor: "SEO", link: { kind: "service", slug: "seo" } } },
          { text: "Paid media can capture immediate demand when it's strategically targeted — useful for launches, seasonal demand or filling the gap while organic visibility is still building." },
          { text: "Together, the two inform each other. Search-intent research shapes both organic content and paid targeting. Landing pages built for a campaign often become the foundation for organic pages later. Measurement from one channel can reveal opportunities the other hasn't captured yet." },
          { text: "Where local visibility specifically matters — Muscat, Dubai or elsewhere in the GCC — that connects directly into our Local SEO work.", link: { anchor: "Local SEO", link: { kind: "service", slug: "local-seo" } } },
        ],
      },
      {
        id: "marketing-and-website",
        eyebrow: "Digital marketing & website experience",
        h2: "Traffic Without a Strong Website Underperforms",
        paragraphs: [
          { text: "The best campaign still underperforms if it lands on a website that doesn't hold up its end. A visitor's decision to enquire or leave is shaped by landing-page clarity, mobile experience, calls to action, trust signals, page speed and how closely the page matches what the ad or post promised.", link: { anchor: "landing-page clarity", link: { kind: "service", slug: "website-design" } } },
          { text: "Message match matters more than most campaigns account for. A visitor who clicks an ad about one specific offer and lands on a general homepage is far more likely to leave than one who lands on a page built around exactly what they clicked for." },
          { text: "Where a site is carrying deeper technical issues — slow load times, poor mobile behaviour, weak crawlability — that limits how much a campaign can achieve regardless of budget, which is where our Technical SEO work applies.", link: { anchor: "Technical SEO", link: { kind: "service", slug: "technical-seo" } } },
        ],
      },
      {
        id: "lead-generation",
        eyebrow: "Lead generation",
        h2: "A Realistic Digital Lead Journey",
        paragraphs: [
          { text: "A digital lead rarely arrives as a finished decision. It moves through a sequence that either holds together or loses people at each step:" },
        ],
        bullets: [
          "Ad, search result or social post — the first point of contact",
          "Landing page — where the visitor evaluates whether to stay",
          "Value proposition — what makes this worth their time",
          "Call to action — a clear, specific next step",
          "Form or contact — the moment interest becomes a lead",
          "Qualification — understanding whether the lead is a genuine fit",
          "Follow-up — the response that determines whether interest converts",
        ],
        afterBullets: [
          { text: "Where the volume of enquiries justifies it, automation can help route and qualify leads faster — though it isn't always necessary, and we scope it based on your actual enquiry volume rather than adding it by default.", link: { anchor: "automation", link: { kind: "service", slug: "business-automation" } } },
          { text: "An AI assistant can also handle first-response and common questions for businesses that need faster, always-available replies — again, only where it genuinely fits the business.", link: { anchor: "AI assistant", link: { kind: "service", slug: "ai-chatbots" } } },
        ],
      },
      {
        id: "oman-uae-gcc",
        eyebrow: "Oman, UAE & GCC",
        h2: "Digital Marketing for Oman, UAE and the GCC",
        paragraphs: [
      ...
      {
        id: "english-arabic-campaigns",
        eyebrow: "English & Arabic",
        h2: "English and Arabic Campaign Considerations",
        paragraphs: [
          { text: "An effective Arabic campaign is localized, not translated. The terminology a customer actually searches and responds to in Arabic often differs from a direct translation of the English version." },
          { text: "Ads, landing pages and messaging need to stay consistent within each language rather than mixing a translated ad with an English-only landing page, which breaks the experience a visitor expects." },
          { text: "A bilingual customer journey should work end to end — from the ad or post, through the landing page, to the enquiry — in whichever language the visitor engaged in." },
          { text: "Performance should be tested and measured by market and language rather than assumed. We don't claim Arabic campaigns will automatically outperform or match English ones — that depends on the audience, category and execution, and it's something to measure, not assume." },
        ],
      },
      {
        id: "vanity-metrics",
        eyebrow: "Measurement philosophy",
        h2: "Paid Media Without Vanity Metrics",
        paragraphs: [
          { text: "Impressions and clicks are easy to report and easy to feel good about. On their own, they say very little about whether a campaign is actually working for the business." },
          { text: "We focus measurement on what's closer to the outcome that actually matters:" },
        ],
        bullets: [
          "Qualified enquiries, not just form submissions",
          "Conversion actions that reflect genuine intent",
          "Cost efficiency against those actions, not raw click volume",
          "Landing-page performance for the traffic each campaign sends",
          "Downstream lead quality, where business data is available to connect it back",
        ],
        afterBullets: [
          { text: "Attribution has real limits. No measurement setup can perfectly credit every touchpoint in a customer's journey, and we're direct about that rather than presenting a dashboard as more precise than it actually is." },
        ],
      },
    ],
    benefitsEyebrow: "What you receive",
    benefitsHeading: "What You Receive",
    benefitsIntro: "The exact scope depends on your business and goals, but a professional OMSA Digital Marketing engagement can include:",
    benefits: [
      "A digital marketing strategy",
      "A channel plan",
      "A campaign framework",
      "Messaging recommendations",
      "Paid-media setup and management, where scoped",
      "Social and content direction",
      "Landing-page recommendations",
      "A tracking and measurement plan",
      "GA4 and campaign tracking, where scoped",
      "A reporting framework",
      "Prioritized optimization recommendations",
    ],
    process: [
      { step: "Business & Growth Discovery", detail: "We start with your business, goals, audience and current channels, so the strategy is built around outcomes that matter — not a generic channel checklist." },
      { step: "Audience & Journey Mapping", detail: "We map how your actual customers discover, evaluate and decide, so channels and messaging follow real behaviour rather than assumptions." },
      { step: "Channel Strategy", detail: "We identify which channels are worth the investment for your business and market, rather than running every channel by default." },
      { step: "Campaign & Content Planning", detail: "Messaging, offers and content are planned to stay consistent across whichever channels are in scope." },
      { step: "Landing-Page Alignment", detail: "Campaign traffic is matched to landing experiences built to convert it, coordinated with our website work where a new page or site is needed.", link: { anchor: "website work", link: { kind: "service", slug: "website-design" } } },
      { step: "Launch & Tracking", detail: "Campaigns launch with measurement already in place, so performance data is available from day one rather than added retroactively." },
      { step: "Analysis & Optimization", detail: "We review what's actually working against the metrics that matter and adjust — budget, messaging, targeting or landing pages — based on evidence." },
      { step: "Ongoing Improvement", detail: "Channels, competition and platforms change continuously, so the strategy is reviewed and adjusted rather than left to run unattended." },
    ],
    postBenefitsSection: {
      id: "vs-seo",
      eyebrow: "Choosing the right service",
      h2: "Digital Marketing vs. SEO",
      paragraphs: [
        { text: "Digital Marketing is the broader umbrella — it can include paid media, social, campaigns, conversion optimization, content and measurement, coordinated around a business goal." },
        { text: "SEO is more specific: it focuses on organic search visibility and search-driven acquisition — the traffic and enquiries that come from ranking well without ongoing spend.", link: { anchor: "SEO", link: { kind: "service", slug: "seo" } } },
        { text: "The two support each other rather than compete. If your priority is long-term organic visibility specifically, our dedicated SEO service is the right starting point. If you need a coordinated strategy across paid, organic, social and conversion, Digital Marketing is the broader engagement." },
      ],
    },
    whoForIntro: "OMSA Digital Marketing is suited to:",
    whoFor: [
      { title: "SMEs and Growing Businesses", body: "Coordinate limited marketing budget across channels instead of spreading it thin across disconnected tactics." },
      { title: "Startups", body: "Build acquisition foundations — messaging, landing pages and measurement — alongside early growth, rather than bolting them on later." },
      { title: "Professional Service Firms", body: "Turn expertise and credibility into a coordinated campaign strategy that generates genuinely qualified enquiries." },
      { title: "Established Companies Launching New Services", body: "Bring a new offer to market with a campaign structure built specifically around it, not adapted from an existing generic template." },
      { title: "Businesses Running Ads Without Clear Measurement", body: "Understand what campaigns are actually contributing, before deciding to spend more or change direction." },
      { title: "Businesses Expanding Across Oman, UAE and the GCC", body: "Build a campaign structure that can extend into new markets with the right localization, rather than duplicating one market's approach everywhere." },
    ],
    preFaqSection: {
      id: "why-omsa",
      eyebrow: "Why OMSA",
      h2: "Why OMSA for Digital Marketing",
      paragraphs: [
        { text: "OMSA works at the intersection of websites, SEO, analytics, AI and automation — which matters for digital marketing specifically, because a campaign's performance is shaped by all of them, not just the ad account." },
        { text: "We build strategy around your business goals first, then coordinate the channels, content and measurement needed to support it, rather than selling channels in isolation." },
        { text: "We're direct about what digital marketing can and can't guarantee. We don't promise a specific cost per lead, a fixed return on ad spend or guaranteed follower growth — no responsible partner can, and we won't pretend otherwise." },
        { text: "What we commit to is a coordinated strategy, transparent reporting and measurement built around outcomes that actually matter to your business." },
      ],
    },
    faqs: [
      { q: "What does digital marketing include?", a: "Digital marketing can include strategy, paid search and social advertising, content and messaging, campaign landing pages, conversion optimization, remarketing and analytics — coordinated around your business goals rather than run as separate, disconnected tactics." },
      { q: "Is digital marketing suitable for small businesses?", a: "Yes. The right scope depends on your budget and goals — a small business generally needs a focused, prioritized channel plan rather than the full breadth of tactics a larger organization might run simultaneously." },
      { q: "What is the difference between Digital Marketing and SEO?", a: "SEO focuses specifically on organic search visibility and search-driven acquisition. Digital Marketing is the broader umbrella, which can include paid media, social, content, conversion optimization and measurement alongside SEO.", link: { anchor: "SEO", link: { kind: "service", slug: "seo" } } },
      { q: "Do you manage Google Ads?", a: "Yes, where it's scoped as part of a Digital Marketing engagement. We build and manage paid search campaigns around high-intent demand, without guaranteeing a specific cost per click, cost per acquisition or ranking position." },
      { q: "Can you help with social media marketing?", a: "Yes. We plan content, distribution and paid social around your business goals. We don't promise follower growth — the focus is relevant reach and engagement that supports genuine business objectives." },
      { q: "How do you measure digital marketing performance?", a: "We track qualified enquiries, conversion actions, cost efficiency and landing-page performance — usually through the same GA4 implementation used across the rest of the business — rather than relying on impressions or clicks alone.", link: { anchor: "GA4 implementation", link: { kind: "service", slug: "google-analytics" } } },
      { q: "Do I need a new website before starting campaigns?", a: "Not always. If your existing website can support clear, high-converting landing pages, campaigns can start there. Where the site can't hold up its end — poor mobile experience, weak message match, technical issues — that's usually worth addressing first, or in parallel.", link: { anchor: "high-converting landing pages", link: { kind: "service", slug: "website-design" } } },
      { q: "Do you provide Digital Marketing services in Oman and UAE?", a: "Yes. OMSA works with businesses across Oman, Muscat, the UAE and the wider GCC, building digital marketing strategies around the market, language and competitive context specific to each." },
    ],
    finalCta: {
      heading: "Move From Disconnected Tactics to a Coordinated Growth System",
      body: "If your channels are running as separate efforts instead of one connected strategy, that's usually the first thing worth fixing. Let's review what you're currently running and identify where a coordinated approach would actually move the business forward.",
      primaryLabel: "Start Your Digital Marketing Strategy",
      secondaryLabel: "Explore SEO Services",
      secondaryLink: { kind: "service", slug: "seo" },
    },
    related: ["seo", "website-design", "google-analytics"],
  },
];
